...
- Contact [support@whitebit.com](https://docs.whitebit.com/faq/)
...
<Accordion title="Is https required for Webhook API communication? What port is used?">
...
<Accordion title="What's the best way to handle API disconnections?">
