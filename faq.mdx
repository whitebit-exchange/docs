...
WhiteBIT offers colocation across EEA/EMEA and APAC regions. Colocation provides access to a subset of 33 trading endpoints. See [Colocation](/platform/colocation) for infrastructure details and the [Market Maker Guide](/guides/market-maker-integration) for the full endpoint list.
</Accordion>
</AccordionGroup>
...
Public endpoints (market data, tickers, orderbook) require no account or authentication. Private endpoints (trading, account management) require API keys — create these keys in account Settings. Institutional features (colocation, OTC, Broker Program) require [institutional onboarding](/institutional/onboarding). See [First API Call](/guides/first-api-call) for the recommended integration path.
</Accordion>
</AccordionGroup>
...
WhiteBIT offers Market-Making Programs, Broker Program (up to 40% fee share), Sub-Account management, OTC trading, Crypto Lending for business, colocation, and Liquidity Provision. See the [Institutional Overview](/institutional/overview) for the full catalog.
</Accordion>
...
Base trading fees are 0.1% maker / 0.1% taker. The Market-Making Program offers rebates up to -0.012% maker. The Broker Program provides up to 40% fee share on referred user trading fees; the applicable rate is agreed individually during enrollment. Contact institutional@whitebit.com for volume-based arrangements.
</Accordion>
...
Colocation is available across EEA/EMEA and APAC regions. Access is limited to a subset of 33 trading endpoints. See [Colocation](/platform/colocation) for setup details and the [Market Maker Guide](/guides/market-maker-integration) for the full endpoint list.
</Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Partner Solutions" icon="signs-post" href="/guides/partner-solutions">
    Find the recommended integration path for market makers, brokers, bot platforms, wallet backends, payment providers, prop firms, and institutional clients.
  </Card>
</CardGroup>
