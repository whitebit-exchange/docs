...
description: "Crypto deposits, withdrawals, withdrawals with currency conversion, fiat operations (SEPA and card providers), and WhiteBIT Codes — status state machines, fee calculation, and webhook reconciliation."
