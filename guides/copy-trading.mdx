...
- **Rate limits apply per account and per endpoint.** A large fan-out is many independent signed requests. Pace the requests and handle `429` with backoff — see [Rate limits](/api-reference/rate-limits).
