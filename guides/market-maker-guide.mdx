...
The Market-Making Program provides dedicated infrastructure for professional liquidity providers: maker-fee rebates, colocation in Frankfurt and Tokyo, and a 33-endpoint API subset reachable from inside the matching-engine zone with 3-5 ms latency.
