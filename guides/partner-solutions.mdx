...
<CardGroup cols={2}>
  ...
  <Card title="Yield-as-a-Service" icon="piggy-bank" href="/guides/yaas-overview">
    Offer Crypto Lending yield to end users, each in a segregated sub-account.
  </Card>
...
| Offer yield/earn to end users (Crypto Lending) | [Yield-as-a-Service](/guides/yaas-overview) |
