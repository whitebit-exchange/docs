...
<CardGroup cols={2}>
  ...
  <Card title="Wallets & White-label" icon="wallet" href="/guides/waas-overview">
...
| Wallets, neobanks, exchange front-ends (backend model selection) | [Wallets & White-label](/guides/waas-overview) |
...
2. Licenses or registrations held, with the regulator and register reference. Unlicensed platforms qualify for models where WhiteBIT verifies end users directly; KYC reliance is separately gated — see the [Wallets & White-label](/guides/waas-overview) page for the eligibility conditions.
