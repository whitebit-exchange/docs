...
fee share model, and revenue monitoring — see [Broker Guide](/guides/sub-account-integration).
...
Brokers can efficiently cancel orders for any client using the structured clientOrderId:
...
|------------|---------|---------------|
| `brk` | Broker prefix | Separates broker flow from other orders |
