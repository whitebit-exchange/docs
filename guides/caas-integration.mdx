...
- **REST and WebSocket.** 100+ authenticated REST endpoints and 14 public endpoints, plus WebSocket
  ...
  connection arrive 2 September 2026 (global platform only), authorized once on the connection rather than
  per request.
...
account via institutional@whitebit.com; see [Regulatory Compliance](/institutional/compliance).
