...
- The partner IP allowlist that the user cannot modify is set at enrollment via WhiteBIT. Coordinate IP updates with `institutional@whitebit.com` before rotating partner infrastructure.
