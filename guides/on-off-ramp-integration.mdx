...
- **Completed institutional onboarding with approved fiat access** — a separate, non-automatic phase after KYB; see [Access and onboarding](/guides/on-off-ramp-overview#access-and-onboarding) on the overview page.
