---
title: "Trading Bot"
description: "Build an automated trading bot in Python on the WhiteBIT v4 API with signed REST orders, WebSocket fills, kill-switch heartbeat, and a grid-bot example."
