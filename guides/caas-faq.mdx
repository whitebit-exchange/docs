...
CaaS availability depends on the target jurisdictions. WhiteBIT confirms which jurisdictions are restricted or unsupported during compliance onboarding; there is no self-serve list. Bring the target regions to onboarding, and route jurisdiction eligibility questions to `compliance@whitebit.com`. See [Restricted jurisdictions](/institutional/compliance#restricted-jurisdictions).
