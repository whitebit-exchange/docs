...
EUR fiat deposits use the same SEPA provider as withdrawals, `SEPA_BCB_GROUP`; the [On/Off-Ramp guide](/guides/on-off-ramp-integration) documents the deposit and withdrawal flows and the per-account values confirmed at onboarding.
