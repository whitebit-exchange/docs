...
- **Bulk and atomic quoting** — place a full quote ladder in a single request and requote by client order identifier ([integration guide](/guides/market-maker-guide)).
