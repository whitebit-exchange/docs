...
Performed when a refund was completed successfully. Request example:
...
Performed when a refund failed. The refund failed because the destination address is unsuitable or other reasons prevent the refund. Try a different address or contact support. Request example:
