...
description: "How Self Trade Prevention (STP) blocks orders from matching against the same trader's other orders to avoid unintentional self-trades on WhiteBIT."
---
