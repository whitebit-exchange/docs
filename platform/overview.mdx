---
title: "API Overview"
description: "The WhiteBIT API covers REST and WebSocket endpoints, base URLs, versioning, and integration setup."
...
- [**OAuth**](/platform/oauth/overview) - Implement secure third-party authorization
