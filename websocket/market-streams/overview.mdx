...
<CardGroup cols={2}>
  ...
  <Card title="Premium index" icon="chart-line-up" href="/websocket/market-streams/premium-index">
    Real-time mark price, index price, and funding rate for futures markets
  </Card>
</CardGroup>
...
- **Add a market** — resubscribe with the full target list, including the markets already being received.
...
- **Manage markets independently** — a connection holds one subscription per channel. To add or drop markets without touching the others, place those markets on separate connections. Weigh the connection limit and added latency described in [WebSocket Rate Limits](/websocket/rate-limits).
