...
<WsSubscribeSteps
  ...
  subscribeNote="params: [market, limit, price_interval, multi_depth]. limit — number of price levels. price_interval — price grouping interval ('0' for no grouping). multi_depth — set true to receive incremental updates."
