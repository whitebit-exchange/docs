...
<CardGroup cols={2}>
  ...
  <Card title="ADL Quantile" icon="gauge-high" href="/websocket/account-streams/adl-quantile">
    Real-time ADL deleveraging-priority rank for open futures positions
  </Card>
</CardGroup>
