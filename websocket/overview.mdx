...
|-------|------|-------------|
| `id` | Integer | Unique identifier to match the response to your request |
...
Private channels (Account Streams) require authorization before you can subscribe. After connecting, send an `authorize` request with your API credentials to gain access to private data such as balances, orders, deals, and positions.

See the [Authorize](/private/websocket/authorize) channel page for the full request format, parameters, and examples.
...
<CardGroup cols={2}>
  <Card title="Market Streams" icon="chart-line" href="/public/websocket/index">
    Public channels for market data — kline, last price, trades, depth, book ticker, and more.
  </Card>
  <Card title="Account Streams" icon="lock" href="/private/websocket/index">
