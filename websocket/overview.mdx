...
description: "WhiteBIT WebSocket API — connection details, quickstart examples, message formats, rate limits, and links to all available channels."
---
...
- [Rate Limits & Error Codes](/api-reference/rate-limits) — REST rate limits, error formats, and authentication errors
