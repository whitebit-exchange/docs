...
<CardGroup cols={2}>
  ...
  <Card title="Order Management" icon="pen-to-square" href="/websocket/order-management/overview">
    Private methods that place, modify, and cancel orders on spot, margin, and futures markets, from 2 September 2026 (global platform only). Requires authorization. See [Order Types](/concepts/order-types) for the available types.
  </Card>
</CardGroup>
