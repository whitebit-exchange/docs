...
- **No leverage needed** — Use [Spot Trading](/products/spot/overview). Direct asset ownership, no liquidation risk, 800+ spot pairs.
...
| [Liquidation risk](/concepts/liquidation) | No | Yes | Yes |
| [Maintenance Margin Rate](/concepts/liquidation) | — | 3% for 1x–10x | 3% for 1x–10x |
...
| Available pairs | 800+ | Spot pairs with collateral enabled | 270+ perpetual pairs |
...
<CardGroup cols={3}>
  <Card title="Spot Trading" icon="arrow-right-arrow-left" href="/products/spot/overview">
    800+ spot pairs, 6 order types, kill-switch, bulk orders. No leverage.
  </Card>
