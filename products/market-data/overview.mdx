...
| WebSocket URL | `wss://wss.whitebit.com/ws` |

Key endpoints:
- `GET /api/v4/public/markets` — All tradable market pairs: spot (including margin-enabled), perpetual futures, and TradFi futures
