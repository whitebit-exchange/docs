...
The partner-operated sub-account model: the partner creates and manages one WhiteBIT sub-account per end user under a master account and holds the sub-account API key. Used by brokers and managed-trading platforms. See [Integration models](/concepts/integration-models).
</Accordion>
