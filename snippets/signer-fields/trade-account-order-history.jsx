...
export const signerFields = [
  ...
  {"name":"status","type":"string","required":false,"description":"Filter list-mode results by order status. Ignored when orderId or clientOrderId is supplied. MAINTENANCE returns only the orders the platform canceled during planned market main…","example":"FILLED","enum":["ALL","FILLED","CANCELED","PARTIALLY_FILLED","MAINTENANCE"],"default":"ALL"},
