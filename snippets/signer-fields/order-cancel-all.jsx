...
export const signerFields = [
  ...
  {"name":"positionSide","type":"string","required":false,"description":"Position side scope. Accepted only when market is a perpetual futures market (e.g., BTC_PERP); values are lowercase on this endpoint.","example":"both","enum":["both","long","short"]},
];
