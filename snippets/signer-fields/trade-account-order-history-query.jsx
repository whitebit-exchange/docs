...
export const signerFields = [
  ...
  {"name":"status","type":"string","required":false,"description":"Category filter — distinct from the response status field. filled returns only reverse close orders (clientOrderId prefixed with delisting-), which carry delistingKind = reverse…","example":"filled","enum":["filled","delisting"]},
