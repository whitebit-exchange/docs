...
export const signerFields = [
  {"name":"market","type":"string","required":false,"description":"Trading pair to filter by. Format: BASE_QUOTE (e.g., BTC_USDT), matching the pattern ^[A-Z0-9]+_[A-Z0-9]+$. Omit to retrieve delisting orders across all markets.","example":"BTC_USDT"},
  {"name":"status","type":"string","required":false,"description":"Category filter. filled returns only reverse close orders (clientOrderId prefixed with delisting-) that reached the filled outcome. delisting returns only orders canceled during…","example":"filled","enum":["filled","delisting"]},
