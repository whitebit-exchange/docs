...
export const signerFields = [
  ...
  {"name":"endDate","type":"integer","required":false,"description":"End of the query window as a Unix timestamp in seconds, applied to the position close time. Optional, no default. Must be ≥ startDate and ≤ now + 1s.","example":"1778100000"},
