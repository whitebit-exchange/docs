...
export const signerFields = [
  ...
  {"name":"urls","type":"array","required":true,"description":"Array of URL objects for API key restrictions. The array is merged into the key's existing settings — URLs not listed keep their current enable value."},
];
