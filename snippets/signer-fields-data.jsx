...
export const SIGNER_FIELDS = {
  ...
  "/api/v4/order/collateral/limit": [
    ...
    {"name":"clientOrderId","type":"string","required":false,"description":"Custom order identifier. Must be unique and contain only letters, numbers, dashes, dots, or underscores.","example":"order1987111"},
  ...
  "/api/v4/main-account/fiat-deposit-url": [
    ...
    {"name":"unique_id","type":"string","required":true,"description":"Unique transaction identifier on client's side","example":"qw22"},
  ...
  "/api/v4/main-account/refund-deposit": [
    {"name":"transaction_id","type":"string","required":true,"description":"Transaction UUID of the deposit. Obtain from the deposit.canceled webhook (uniqueId field) or from the deposit/withdraw history in the WhiteBIT interface.","example":"54bffeb7-7a8f-43f8-bcd8-f14ec10fee85"},
  ...
  "/api/v4/main-account/withdraw": [
    ...
    {"name":"unique_id","type":"string","required":true,"description":"Unique transaction identifier. ⚠️ Generate a new unique ID for each withdrawal request.","example":"24529041"},
    ...
    {"name":"beneficiary","type":"object","required":false,"description":"Beneficiary information data array. ⚠️ Required if currency ticker is one of: UAH_IBAN, USD_VISAMASTER, EUR_VISAMASTER, USD, EUR"},
    {"name":"travelRule","type":"object","required":false,"description":"Travel Rule information data array. ⚠️ Required if currency is crypto and the account is from EEA"},
  ...
  "/api/v4/main-account/codes": [
    ...
    {"name":"amount","type":"string","required":true,"description":"Amount to transfer. Max precision = 8, value must be greater than zero and less than or equal to the main balance.","example":"0.002"},
    ...
    {"name":"description","type":"string","required":false,"description":"Additional text description for code. Visible only for creator. Max: 75 symbols.","example":"some description"},
  ],
