{/* Shared eligibility wording for KYC reliance — used by guides/sub-account-integration.mdx,
    guides/broker-overview.mdx, guides/waas-integration.mdx, guides/waas-overview.mdx, and
    guides/platforms-overview.mdx. The substance follows the Compliance guidance of 2026-07-30;
    edits to the text require Compliance review before merge. Edit the wording only here. */}
