{/* Shared eligibility wording for KYC reliance — used by guides/broker-guide.mdx,
    guides/broker-overview.mdx, and guides/waas-guide.mdx. The substance follows the Compliance guidance of 2026-07-30;
