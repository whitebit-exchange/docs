{/* Shared eligibility wording for KYC reliance — used by guides/sub-account-integration.mdx,
    guides/embedded-trading-overview.mdx, guides/waas-integration.mdx, and guides/waas-overview.mdx.
    The substance follows the Compliance guidance of 2026-07-30; edits to the text require
