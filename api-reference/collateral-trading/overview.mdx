...
<CardGroup cols={2}>
  ...
  <Card title="Query Unexecuted Orders" icon="list-check" href="/api-reference/spot-trading/query-unexecuted-orders">
    Open orders on spot and futures markets
  </Card>
  <Card title="Query Executed Orders" icon="clock-rotate-left" href="/api-reference/spot-trading/query-executed-orders">
    Executed and canceled order history (spot and futures)
  </Card>
  <Card title="Query Executed Order History" icon="rectangle-history" href="/api-reference/spot-trading/query-executed-order-history">
    Full execution history
  </Card>
  <Card title="Query Executed Order Deals" icon="receipt" href="/api-reference/spot-trading/query-executed-order-deals">
...
<CardGroup cols={2}>
  ...
  <Card title="Closed-Position PNL" icon="sack-dollar" href="/api-reference/collateral-trading/closed-position-pnl">
