...
- The `permissions` array lists the permission groups the user granted on the consent screen — see [Key permissions](/guides/fast-api-key-via-oauth#key-permissions) for the full permission model.
