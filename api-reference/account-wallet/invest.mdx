...
import { signerFields } from '/snippets/signer-fields/main-account-smart-investment.jsx';

<WhitebitSigner path="/api/v4/main-account/smart/investment" fields={signerFields} />
