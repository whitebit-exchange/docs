...
description: "Retrieve the history of Flex investment operations including deposits and withdrawals via the V4 API."
...
<WhitebitSigner path="/api/v4/main-account/smart-flex/investments/history" fields={SIGNER_FIELDS["/api/v4/main-account/smart-flex/investments/history"]} />
