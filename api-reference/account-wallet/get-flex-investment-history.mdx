...
import { signerFields } from '/snippets/signer-fields/main-account-smart-flex-investments-history.jsx';

<WhitebitSigner path="/api/v4/main-account/smart-flex/investments/history" fields={signerFields} />
