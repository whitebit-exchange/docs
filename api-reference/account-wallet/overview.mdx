...
<CardGroup cols={2}>
  ...
  <Card title="Get Fiat Deposit URL" icon="money-bill" href="/api-reference/account-wallet/get-fiat-deposit-url">
    Generate a fiat deposit URL and payment details
  </Card>
  ...
  <Card title="Create Express Withdraw Token" icon="bolt" href="/api-reference/account-wallet/create-express-withdraw-token">
    Create a single-use payment token that charges a WhiteBIT user's balance
  </Card>
  ...
  <Card title="Get Transfer History" icon="clock-rotate-left" href="/api-reference/account-wallet/get-transfer-history">
    Get the history of transfers between balances
  </Card>
  ...
  <Card title="Refund Deposit" icon="rotate-left" href="/api-reference/account-wallet/refund-deposit">
    Refund a canceled deposit
  </Card>
  <Card title="Get Refund History" icon="clock-rotate-left" href="/api-reference/account-wallet/get-refund-history">
    Get deposit refunds and their status
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Get Account Codes" icon="list" href="/api-reference/account-wallet/get-my-codes">
    Get created codes
  </Card>
