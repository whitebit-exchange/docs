...
<CardGroup cols={2}>
  ...
  <Card title="Query Market Fee For A Single Market" icon="percent" href="/api-reference/spot-trading/query-market-fee-single">
    Retrieve the effective maker and taker fee and the RPI maker fee premium for one market
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Query Delisting Orders" icon="ban" href="/api-reference/spot-trading/query-delisting-orders">
    Get delisting order history
  </Card>
</CardGroup>
