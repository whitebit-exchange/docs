...
<CardGroup cols={2}>
  <Card title="Query Market Fees" icon="percent" href="/api-reference/spot-trading/query-market-fee">
    Retrieve default maker and taker rates and custom per-market overrides
  </Card>
  <Card title="Query Market Fee For A Single Market" icon="percent" href="/api-reference/spot-trading/query-market-fee-single">
...
<CardGroup cols={2}>
  ...
  <Card title="Query Delisting and Maintenance Orders" icon="ban" href="/api-reference/spot-trading/query-delisting-orders">
