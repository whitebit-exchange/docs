...
<CardGroup cols={2}>
  ...
  <Card title="ADL Quantile" icon="gauge" href="/api-reference/trading/adl-quantile">
    Get deleveraging-priority values per perpetual market
  </Card>
  ...
  <Card title="Borrow History" icon="hand-holding-dollar" href="/api-reference/trading/borrow-history">
