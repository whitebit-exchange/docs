...
<CardGroup cols={2}>
  ...
  <Card title="Trading" icon="chart-line" href="/api-reference/spot-trading/overview">
...
- [Trading](/api-reference/spot-trading/overview) — Spot and collateral orders, queries, and positions
