...
For a runnable signing implementation in Python, see [First API Call](/guides/first-api-call).
...
<CardGroup cols={2}>
  ...
  <Card title="Trading" icon="chart-line" href="/api-reference/trading/spot-overview">
    Spot and collateral (margin/futures) trading: orders, order queries, positions, leverage, hedge mode, and kill-switch timers.
  </Card>
  <Card title="Convert" icon="rotate" href="/api-reference/convert/overview">
  ...
  <Card title="Travel Rule" icon="passport" href="/api-reference/travel-rule/overview">
  ...
  <Card title="Mining Pool" icon="pickaxe" href="/api-reference/mining-pool/overview">
    Monitor mining operations, manage payouts, track worker performance, and create watcher links.
  </Card>
  <Card title="Address Checker" icon="shield-check" href="/api-reference/address-checker/overview">
...
- [Trading](/api-reference/trading/spot-overview) — Spot and collateral orders, queries, and positions
- [WebSocket API](/websocket/overview) — Real-time market data and account streams, plus order management from September 2, 2026 (global platform only)
- [SDKs](/sdks) — Official Go, Python, and PHP SDKs
