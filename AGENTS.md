...
| Humanize rewrite | `ai/skills/humanize-rewrite/SKILL.md` | On demand — rewrite a guide, institutional, best-practices, or product page to remove AI-voice tells while preserving every style-guide rule |
