...
<div className="w-full flex flex-col items-center justify-center py-6 text-center px-4">
  ...
  <div className="flex items-center justify-center gap-4 mt-6">
    <span className='px-3 py-1 bg-gray-200 dark:bg-gray-900 rounded-full dark:text-white text-black flex items-center gap-2'>
      <span className='text-sm'>900+ Markets</span>
    </span>
    <span className='px-3 py-1 bg-gray-200 dark:bg-gray-900 rounded-full dark:text-white text-black flex items-center gap-2'>
...
<div className='my-8'>
  ...
  <p className="text-lg text-center" style={{ fontWeight: '500', maxWidth: '40rem', margin: '0 auto', marginTop: '0.5rem' }}>
    Find the integration path for each partner type.
  </p>
</div>

<CardGroup cols={2}>
  <Card title="Embedded Trading" icon="handshake" href="/guides/partner-solutions">
    Per-customer sub-accounts under a partner master, or apps built over users' own accounts via a partner-held API key.
  </Card>
  <Card title="Market Makers" icon="chart-mixed" href="/guides/partner-solutions">
    Maker rebates, colocation infrastructure, and bulk-order capabilities through the Market-Making Program.
  </Card>
  <Card title="Payments & Fiat" icon="money-bill-transfer" href="/guides/partner-solutions">
    Deposits, payouts, merchant flows, and corporate on/off-ramp between fiat and crypto.
  </Card>
  <Card title="Funds & Institutions" icon="building-columns" href="/guides/partner-solutions">
...
<CardGroup cols={3}>
  ...
  <Card title="Spot Trading" icon="arrow-right-arrow-left" href="/products/spot/overview">
    800+ spot pairs with 6 order types including bulk orders.
  </Card>
...
The following features are available through the WhiteBIT platform interface and are not accessible via API: Auto-Invest, Nova Card, Staking, P2P, and the built-in Copy Trading feature (partner-built copy trading over user-granted API keys is a separate integration — see [Fast API Key via OAuth](/guides/fast-api-key-integration)). Visit [whitebit.com](https://whitebit.com) for details.
