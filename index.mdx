...
<CardGroup cols={2}>
  ...
  <Card title="Broker Program" icon="building-columns" href="/guides/broker-overview">
    Two integration architectures — partner-operated sub-accounts or customers' own accounts via Fast API Key — fee sharing, and onboarding.
  </Card>
</CardGroup>
