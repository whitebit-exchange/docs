...
The following features are available through the WhiteBIT platform interface and are not accessible via API: Auto-Invest, Nova Card, Staking, and P2P. Visit [whitebit.com](https://whitebit.com) for details.
