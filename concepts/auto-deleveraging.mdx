...
description: "How auto-deleveraging works on WhiteBIT futures: a final-stage liquidation that closes profitable counterparty positions when liquidity is insufficient."
