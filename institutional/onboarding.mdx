...
**Timeline:** Timeline varies depending on corporate structure, document availability, and compliance feedback cycles. Allow 2-4 weeks for Phase 1 and an additional 2-4 weeks for Phase 2. Contact institutional@whitebit.com for current processing estimates. {/* verify timeline with the institutional team */}
...
<Note>
  **Enabling crypto deposits.** Crypto deposits are disabled by default. Once enabled for the
  ...
  enablement is not available via API. To request it, contact the assigned Account Manager or
...
<CardGroup cols={2}>
  ...
  <Card title="On/Off-Ramp Guide" icon="arrow-right-arrow-left" href="/guides/on-off-ramp-integration">
    Fiat EUR/SEPA rails via API after Phase 2 — deposits, withdrawals, conversion, and reconciliation.
  </Card>
</CardGroup>
