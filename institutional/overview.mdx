...
**[Colocation](/platform/colocation)** *API* -- Low-latency infrastructure in AWS `eu-central-1` and `ap-northeast-1` (Tokyo). 3-5 millisecond latency. 34 endpoints available via colocation. Contact account manager for connection details including base URLs and availability zone placement.
