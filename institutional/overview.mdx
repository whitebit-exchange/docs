...
API key authentication (HMAC-SHA512) is the primary integration method. Fast API Key -- an OAuth-issued API key for acting on a customer's own account -- is live; see [Fast API Key via OAuth](/guides/fast-api-key-via-oauth).
