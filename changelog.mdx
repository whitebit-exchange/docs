...
<CardGroup cols={2}>
  <Card title="Query executed orders" href="/api-reference/spot-trading/query-executed-orders" icon="list-check" horizontal/>
  <Card title="Query delisting and maintenance orders" href="/api-reference/spot-trading/query-delisting-orders" icon="ban" horizontal/>
</CardGroup>
</Update>
...
<CardGroup cols={2}>
  <Card title="Query market fee for a single market" href="/api-reference/spot-trading/query-market-fee-single" icon="percent" horizontal/>
  <Card title="Query market fees" href="/api-reference/spot-trading/query-market-fee" icon="percent" horizontal/>
</CardGroup>
</Update>
...
<CardGroup cols={2}>
  <Card title="Closed-position PNL" href="/api-reference/collateral-trading/closed-position-pnl" icon="sack-dollar" horizontal/>
  <Card title="Positions history" href="/api-reference/collateral-trading/positions-history" icon="clock-rotate-left" horizontal/>
</CardGroup>
</Update>
...
<CardGroup cols={2}>
  ...
  <Card title="Collateral Limit Order" href="/api-reference/collateral-trading/collateral-limit-order" icon="layer-group" horizontal/>
...
- [Query unexecuted orders](/api-reference/spot-trading/query-unexecuted-orders) (`POST /api/v4/orders`) — search open orders by `clientOrderId`.
- [Query executed orders](/api-reference/spot-trading/query-executed-orders) (`POST /api/v4/trade-account/order/history`) — search filled and canceled orders by `clientOrderId`.
...
<CardGroup cols={2}>
  ...
  <Card title="Create Limit Order" href="/api-reference/spot-trading/create-limit-order" icon="chart-line" horizontal/>
  <Card title="Query unexecuted orders" href="/api-reference/spot-trading/query-unexecuted-orders" icon="magnifying-glass" horizontal/>
  <Card title="Query executed orders" href="/api-reference/spot-trading/query-executed-orders" icon="clock-rotate-left" horizontal/>
</CardGroup>
</Update>
